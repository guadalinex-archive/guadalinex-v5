...
nsPluginInstallerWizard.prototype.createPluginSetGroupBox = function () {
  ...
  caption.setAttribute("label", this.getString("guadafox.pluginWizard.availablePluginsPage.description.label")+" "+mimetype+":");
...
nsPluginInstallerWizard.prototype.showPluginList = function () {
  ...
  for (mimetype in this.mPluginInfoArray){
	...
	distributorImage.setAttribute("src", "chrome://guadafox/content/guadalinexlogo32.png");
	pluginInfo.IconUrl = "chrome://guadafox/content/guadalinexlogo32.png";
      } else {
	if(!pluginInfo.IconUrl || pluginInfo.IconUrl.length == 0) {
	  distributorImage.setAttribute("src", "chrome://guadafox/content/internet32.png");
	  pluginInfo.IconUrl = "chrome://guadafox/content/internet32.png";
	} else {
...
nsPluginInstallerWizard.prototype.getString = function (aName){
  ...
  try {
    ...
    result = document.getElementById("guadafoxPluginWizardString").getString(aName);
  }
  return result;
}
...
nsPluginInstallerWizard.prototype.getFormattedString = function (aName, aArray){
  ...
  try {
    ...
    result = document.getElementById("guadafoxPluginWizardString").getFormattedString(aName, aArray);
  }
  return result;
}
