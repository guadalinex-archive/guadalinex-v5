...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\guadafox on
     Windows, /home/user/dev/guadafox on Linux) in a file named
     guadafox@guadalinex.org and copy that file to
