...
from vmc.qt.collaborator import QtCollaboratorFactory
from vmc.contrib.epsilon.modal import mode

class QtBehaviour(Behaviour):
    """
    Behaviour for Qt
    """
    collaborator = QtCollaboratorFactory
    ...
    def __init__(self, device, dialer, sm_callbacks, sm_errbacks, ctrl):
        super(QtBehaviour, self).__init__(device, dialer,
