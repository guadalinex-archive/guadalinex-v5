...
from vmc.qt.behaviour import QtBehaviour

class QtWrapper(BaseWrapper):
    """
    Wrapper for Qt
    """
    BEHAVIOUR_KLASS = QtBehaviour
    
    def __init__(self, device, noti_callbacks,
                 sm_callbacks, sm_errbacks, ctrl):
        self.ctrl = ctrl
        super(QtWrapper, self).__init__(device, noti_callbacks, sm_callbacks,
                                         sm_errbacks)
