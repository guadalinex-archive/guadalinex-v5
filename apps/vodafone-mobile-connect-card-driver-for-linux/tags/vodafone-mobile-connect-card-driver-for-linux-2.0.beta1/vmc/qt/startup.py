...
from vmc.qt.controllers.initialconf import (NewProfileController,
                                             DeviceSelectionController)
from vmc.qt.controllers.splash import SplashController
from vmc.qt import Model
from vmc.qt.models.initialconf import NewProfileModel
from vmc.qt.views.initialconf import NewProfileView, DeviceSelectionView
from vmc.qt.views.splash import SplashView

class QtSerialService(Service):
    """
...
class QtStartupController(object):
    """
...
def hook_it_up(splash, device_listener, device=None):
    ...
    # get main screen up
    from vmc.qt.models.application import ApplicationModel
    from vmc.qt.views.application import ApplicationView
    from vmc.qt.controllers.application import ApplicationController
    ...
    from vmc.qt.wrapper import QtWrapper
    ctrl.model.wrapper = QtWrapper(device,
                                    unsolicited_notifications_callbacks,
                                    statemachine_callbacks,
...
def check_posix_dependencies():
    ...
    try:
        ...
        resp.append("python-qt4 module not found, please install it")
